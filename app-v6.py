...
if not st.session_state.logged_in:
    ...
    if role == "admin":
        ...
        if menu == "📂 مدیریت کاربران و اکسل":
            ...
            if st.button("🔙 بازگشت به صفحه اصلی", key="back_btn_admin_recs"): st.session_state.admin_menu_sel = "📂 مدیریت کاربران و اکسل"; st.rerun()
            ...
            if st.button("🔙 بازگشت به صفحه اصلی", key="back_btn_admin_plans"): st.session_state.admin_menu_sel = "📂 مدیریت کاربران و اکسل"; st.rerun()
        ...
        if menu == "📢 تابلوی اعلانات":
            ...
            tab_upload_plan, tab_my_plans = st.tabs([
                "📤 بارگذاری طرح درس جدید",
            ...
            with tab_video:
                ...
                default_links = {
                    ...
                    "🔗 لینک مستقیم و سفارشی (Custom Link)": "https://meet.jit.si/mofatteh_jask_math_class"
                }
    ...
    SELECT id, title as "عنوان فیلم", subject as "درس", grade as "پایه", month as "ماه", chapter as "فصل/ترم", video_url as "لینک", upload_date as "تاریخ ثبت"
        ...
        if menu == "🏫 ثبت‌نام کلاس‌های تقویتی و خصوصی":
            ...
            with tab_student_video:
                ...
                active_platform = r_plat["val"] if r_plat else "💻 Jitsi Meet (محیط بومی بدون فیلتر و پرسرعت)"
                active_link = r_link["val"] if r_link else "https://meet.jit.si/mofatteh_jask_math_class"
